				...
				<div className="row justify-content-center position-relative">
					<div className="col-lg-6 text-center align-self-center topping">
						...
						<p className="text-white splashText-left">
							...
							scheduling from the comfort and convenience of your own home. One
							application works for all service industries, including
			...
			<div className="container ">
				<div className="row justify-content-center splash-border position-relative">
					...
					<div className="col-lg-6 align-self-center text-center topping">
						...
						<br />
						<p className="text-white splashText-left">
							The Jay&Co Custom Scheduling App Plus provides the same enterprise
							level scheduling as the standard application with the added
							functionality of detailed scheduling analysis so that you can more
							effeciently manange your time.
						</p>
					</div>
				</div>
			</div>
				...
				<div className="row justify-content-center splash-border position-relative">
					...
					<div className="col-lg-6 align-self-center text-center topping">
						...
						<p className="text-white splashText-left">
							...
							Scheduling App Plus Plus Plus can. Not only does this application
							schedule, but it also finds you jobs/clients that pay your
							business well above the market rate. Its going to blow your
							scheduling needs out of the water.
						</p>
					</div>
				</div>
			</div>
